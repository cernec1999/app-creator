			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class = "active"><a href="unread.php">Unread Applications</a></li>
				...
				<div class="col-sm-3 col-md-2 sidebar" style="left: auto; right: 0px">
					<ul class="nav nav-sidebar">
						<?php
							$col1 = mysqli_query($con, "SELECT * FROM " . $config['mysql_table'] . " WHERE category = 'Unread Apps' ORDER BY id ASC");
							while($row1 = mysqli_fetch_array($col1)) {
								if(isset($_GET['id']) && $_GET['id'] == $row1['id']) {
									echo "<li class = \"active\"><a href=\"unread.php?id=" . $row1['id'] . "\">" . $row1['q1'] . "</a></li>\n";
								} else {
									echo "<li><a href=\"unread.php?id=" . $row1['id'] . "\">" . $row1['q1'] . "</a></li>\n";
								}
							}
						?>
					</ul>
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h1 class="page-header">Unread Applications</h1>
					<?php
						if(isset($_GET['id'])) {
					?>
